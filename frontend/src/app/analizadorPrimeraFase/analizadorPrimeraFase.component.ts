...
import { AnalizadorPrimeraFaseService } from '../services/analizadorPrimeraFase.service';
import { ViewChild } from '@angular/core';

@Component({
  selector: 'app-analizador',
  templateUrl: './analizadorPrimeraFase.component.html',
  styleUrls: ['./analizadorPrimeraFase.component.css']
})
export class AnalizadorPrimeraFaseComponent implements OnInit {
  ...
  constructor(private monacoLoaderService: MonacoEditorLoaderService, private analizarService: AnalizadorPrimeraFaseService) {
